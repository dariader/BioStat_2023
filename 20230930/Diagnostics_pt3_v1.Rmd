...
arteries_data <- read.csv("./20230930/arterial_occlusion_data.csv")
...
roc_curve_1 <- roc(Arterial_occlusion ~ ABI, 
                   data = arteries_data_cleaned, ci = TRUE)
...
roc_curve_2 <- roc(response = arteries_data$Arterial_occlusion,
                   predictor = sample(1:140, 140, replace = T), ci = TRUE)
roc_curve_2
```
...
roc_curve_3 <- roc(response = arteries_data$Arterial_occlusion,
                   predictor = arteries_data$US_diameter, ci = TRUE)
roc_curve_3 %>% ggroc()
max(arteries_data$US_diameter)
```
